...
E : E SUM T {$$ = $1 + $3; System.out.println("Pila: "+$$);}
  | E MIN T {$$ = $1 - $3; System.out.println("Pila: "+$$);}
  | T
;

T: T MULT INTEGER {$$ = $1 * $3; System.out.println("Pila: "+$$);}
  | T DIV INTEGER {$$ = $1 / $3; System.out.println("Pila: "+$$);}
  | INTEGER {$$ = $1;}
;
